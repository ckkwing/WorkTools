...
namespace DBUtility
{
    public abstract class SqliteHelper
    {
        ...
        /// <param name="commandParameters">an array of SQLiteParameter used to execute the command</param>
        ...
        /// <param name="cmdParms">an array of SQLiteParameter to be cached</param>
        ...
        /// <returns>Cached SQLiteParameter array</returns>
